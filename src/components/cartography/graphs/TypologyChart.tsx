...
import { typologyData } from '../../../data/cartography/cartographyData';
...
export function TypologyChart() {
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-3xl border-0 shadow-xl hover:shadow-2xl transition-all duration-300 animate-fade-in hover:scale-[1.02] p-6">
      <div className="mb-4">
        <h3 className="text-xl font-bold text-gray-900">Typologie</h3>
        <p className="text-sm text-gray-600 mt-1">Répartition des types de fraude</p>
      </div>
