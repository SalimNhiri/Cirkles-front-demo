...
import { FiltersBanner } from '../components/filters/FiltersBanner';
import { ActiveFiltersBadges } from '../components/filters/ActiveFiltersBadges';

function ActionsBar() {
  const { setOpen, open } = useFilters();
  return (
    <div className="flex space-x-4">
      ...
      <button
        className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all shadow-sm"
